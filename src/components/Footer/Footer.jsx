...
const Footer = () => {
  return (
    <footer className="bg-[#0a0a0a] py-10 px-8 font-serif border-t border-gray-900">
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <ul className="space-y-4 text-sm">
                {['Inicio', 'Festivales', 'Premios'].map((item) => (
                  <li 
                    key={item}
                    className="text-gray-600 hover:text-[#c5a04a] hover:font-bold cursor-pointer transition-all duration-300"
                  >
                    {item}
                  </li>
                ))}
        ...
        <div className="mt-16 pt-8 border-t border-gray-900 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-widest">
          <p className="text-gray-700">© 2026 IBERIAN MOVIE — Todos los derechos reservados</p>
