...
const Footer = () => {
  return (
    <footer className="bg-[#0a0a0a] text-gray-500 py-12 px-8 font-serif border-t border-gray-900">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-6">
          ...
          {/* Iconos de Redes Sociales solicitados */}
        ...
        <div className="md:col-span-6 grid grid-cols-2 gap-8">
          {/* Navegación */}
          <div>
            <h3 className="text-white font-bold text-[11px] uppercase tracking-[0.3em] mb-6">Navegación</h3>
            <ul className="space-y-4 text-sm">
              <li className="hover:text-white cursor-pointer transition-colors">Inicio</li>
              <li className="hover:text-white cursor-pointer transition-colors">Directores</li>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-white font-bold text-[11px] uppercase tracking-[0.3em] mb-6">Legal</h3>
            <ul className="space-y-4 text-sm">
