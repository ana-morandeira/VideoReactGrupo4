  ...
  return (
    <footer className="bg-[#0a0a0a] text-gray-300 py-10 px-8 font-serif border-t border-gray-900">
      <div className="max-w-6xl mx-auto">
        {/* Sección Superior: Logo + Redes y Navegación + Legal */}
          ...
          <div className="md:col-span-6 flex flex-col items-center">
            ...
            <div className="flex gap-2">
              {[FaFacebookF, FaInstagram, FaRegEnvelope, FaThreads].map((Icon, index) => (
                <div key={index} className="w-10 h-10 bg-[#1a1a1a] rounded flex items-center justify-center hover:bg-gray-800 transition-all cursor-pointer text-gray-400 hover:text-[#c5a04a]">
                  <Icon size={20} />
                </div>
              ))}
            </div>
       ...
       {/* Lado Derecho: Navegación y Legal */}
<div className="md:col-span-6 grid grid-cols-2 gap-8 pt-14">
  ...
  <div>
    ...
    <ul className="space-y-4 text-sm text-gray-500"> {/* Color base más oscuro para que el hover destaque */}
      <li className="hover:text-white cursor-pointer transition-all duration-200 hover:translate-x-1">Inicio</li>
      <li className="hover:text-white cursor-pointer transition-all duration-200 hover:translate-x-1">Festivales</li>
      <li className="hover:text-white cursor-pointer transition-all duration-200 hover:translate-x-1">Premios</li>
    </ul>
  </div>
  ...
  <div>
    ...
    <ul className="space-y-4 text-sm text-gray-500">
      <li className="hover:text-white cursor-pointer transition-all duration-200 hover:translate-x-1">Prensa</li>
      <li className="hover:text-white cursor-pointer transition-all duration-200 hover:translate-x-1">Soporte</li>
      <li className="hover:text-white cursor-pointer transition-all duration-200 hover:translate-x-1">Colaboraciones</li>
    </ul>
  </div>
</div>
